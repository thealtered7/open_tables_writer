        ...
        try {
            observability.observeCallableVoid(
                    ...
                    () -> {
                        ...
                        log.info(
                                "Processing table-updated notification: table_fqn={}, format={}, table_path={}, extract_job_id={}, extract_buffer_id={}",
            ...
            log.error(
                    ...
                    e);
            try {
                String tableIdentity = notification == null ? null : notification.tableFqn();
